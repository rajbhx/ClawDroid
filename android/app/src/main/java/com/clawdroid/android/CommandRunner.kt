...
object CommandRunner {
    ...
    fun runSync(command: String, env: Map<String, String>, workDir: File, timeoutMs: Long = 10_000): CommandResult =
        try {
    ...
    suspend fun runStreaming(command: String, env: Map<String, String>, workDir: File, onOutput: (String) -> Unit) =
